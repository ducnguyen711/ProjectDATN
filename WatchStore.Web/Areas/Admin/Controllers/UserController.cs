...
using WatchStore.Web.Areas.Admin.Models.User;
...
namespace WatchStore.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, WatchStoreDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
