...
using WatchStore.Web.Areas.Admin.Models.Models;
using WatchStore.Web.Areas.Admin.Models.Role;
using WatchStore.Web.Areas.Identity.Data;
using WatchStore.Web.Data;
using WatchStore.Web.Extension;
...
namespace WatchStore.Web.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, WatchStoreDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
